...
w = Canvas(main, width = 550, height = 700, background = "#3e5151", bd=0, highlightthickness=0)
w.pack()
...
pipeUp = w.create_rectangle(PIPE_X, 0, PIPE_X + 100, PIPE_HOLE, fill="#000", outline="#fff")
pipeDown = w.create_rectangle(PIPE_X, PIPE_HOLE + 200, PIPE_X + 100, 700, fill="#000", outline="#fff")
...
def engGameScreen():
	...
	global endScore
	global endBest
	endRectangle = w.create_rectangle(0, 0, 550, 700, fill='#3e5151')
